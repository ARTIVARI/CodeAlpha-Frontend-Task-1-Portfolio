...
const Login=()=> {
        ...
        const handleLogin = () => {
          if (email === validUser.email && password === validUser.password) {
            navigate('/vyavasthaapakprist'); // Redirect to the admin page
          } else {
            navigate('/*')
  ...
  return (
    <div>
        <section>
                <div className="flex flex-col items-center  px-3 mx-auto md:h-full lg:py-0">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-start">
                                <div className="flex items-center h-5">
                                    <input id="remember" aria-describedby="remember" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-yellow-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-yellow-500 dark:ring-offset-yellow-500" required=""/>
                                </div>
